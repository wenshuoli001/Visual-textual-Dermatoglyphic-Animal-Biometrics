...
#SBATCH --time=5:00:00
#SBATCH --mem=64G
#SBATCH --exclude=bp1-gpu024,bp1-gpu027,bp1-gpu030
...
#run code
python train.py --name iira --img_aug --loss_names 'itc+id' --dataset_name 'RSTPReid' --root_dir 'reiddataset_real+1000' --num_epoch 50
